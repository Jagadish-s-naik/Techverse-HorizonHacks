...
export const simulateReceiveSMS = async (req, res) => {
    ...
    try {
        ...
        const result = await query('SELECT crop, mandi, price_low as price_range_low, price_high as price_range_high, trend, confidence, drivers FROM forecasts WHERE crop = $1 ORDER BY forecast_date DESC LIMIT 1', [crop]);
